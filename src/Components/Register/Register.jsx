  ...
  return (
    ...
    <div className={`${style.regesiter} py-5 m-auto w-75`} >
      ...
      <div className="inputData} my-2">
          ...
          <input onChange={inputData} type="text" name='first_name' className='form-control my-3' />
          {userValidation.first_name.error ? <div className={`${style.errorMsg} alert p-1 text-start`}>
          {userValidation.first_name.errorMessage}</div> : ""}
        </div>
        <div className="inputData} my-2">
          <label htmlFor="last_name">Last Name</label>
          <input onChange={inputData} type="text" name='last_name' className='form-control my-3' />
          {userValidation.last_name.error ? <div className={`${style.errorMsg} alert p-1 text-start`}>
          {userValidation.last_name.errorMessage}</div> : ""}
        </div>
        <div className="inputData} my-2">
        ...
        <div className="inputData} my-2">
          ...
          <input onChange={inputData} type="number" name='age' className='form-control my-3' />
          {userValidation.age.error ? <div className={`${style.errorMsg} alert p-1 text-start`}>
          {userValidation.age.errorMessage}</div> : ""}
        </div>
        <div className="inputData} my-2">
      ...
      {load?<button className="myBtn btn btn-danger my-3 float-end spinner-border spinner-border-sm ">Register</button>: <button className="myBtn btn btn-danger my-3 float-end ">Register</button>}
      </form>
